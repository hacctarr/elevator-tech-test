...
class TestElevator(unittest.TestCase):
    ...
    def test_generate_random_calls(self):
        ...
        self.assertIn(list(time_series.values())[0][0].destination_floor, range(1, 5))
        ...
        for passenger in passengers:
            self.assertIn(passenger.destination_floor, range(1, 5))
    ...
    def test_generate_uniform_calls_with_lognormal_passengers(self):
        ...
        self.assertIn(list(time_series.values())[0][0].start_floor, range(1, 5))
        self.assertIn(list(time_series.values())[0][0].destination_floor, range(1, 5))
        ...
        for passengers in time_series.values():
            ...
            self.assertIn(passengers[0].start_floor, range(1, 5))
            self.assertIn(passengers[0].destination_floor, range(1, 5))
